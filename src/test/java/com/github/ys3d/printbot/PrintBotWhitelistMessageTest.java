...
public class PrintBotWhitelistMessageTest {
    ...
    public PrintBotWhitelistMessageTest(int messageId, boolean correct) {
    ...
    public void isWhitelistedMessagePositive() throws IOException {
        ...
        assertEquals(correct, PrintBot.isWhitelisted(new TestUpdate(new TestMessage(messageId))));
    }
}
